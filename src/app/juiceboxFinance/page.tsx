    ...
    <main>
      <div className="w-full h-full flex flex-col items-center">
        <div className="flex flex-col space-y-4">
          <div className="rounded-lg p-3 bg-zinc-950 w-[90vw] md:min-w-[48rem] md:w-[50vw] shadow-lg text-center">
          ...
          <div className="rounded-lg p-3 bg-zinc-950 w-[90vw] md:min-w-[48rem] md:w-[50vw] shadow-lg">
