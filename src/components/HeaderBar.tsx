...
export default function HeaderBar () {
  return (
    <div className="fixed left-0 right-0 flex space-x-1 items-center justify-center min-h-[6rem] bg-gray-100 dark:bg-gray-900 text-left text-2xl font-semibold z-10">
