    ...
    <div className="rounded-lg bg-zinc-100 dark:bg-zinc-950 w-[90vw] md:w-[48rem] shadow-lg dark:shadow-gray-800">
      <div className="px-3 py-3 md:px-4 md:py-4 flex flex-col justify-center space-y-2 md:space-y-4">
        ...
        <div className="flex flex-col space-y-2 items-center justify-center">
          ...
          <div className="flex flex-row justify-center items-center px-3 py-3 md:px-4 md:py-4 space-x-2 rounded-xl shadow-xl w-[67.5vw] h-[38.5vw] md:w-[30rem] md:h-[17rem] hover:scale-[1.05] shadow-xl shadow-gray-600 dark:shadow-gray-300 dark:shadow-md transition-all duration-200 ease-in-out bg-gradient-to-r from-gray-500 via-gray-400 to-gray-300 dark:from-gray-800 dark:via-gray-600 dark:to-gray-500">
